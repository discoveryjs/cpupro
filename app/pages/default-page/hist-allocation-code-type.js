...
export const histAllocationCodeType = {
    view: 'expand',
    data: 'memline.byCodeType.[value].sort(name.order() asc)',
    whenData: true,
    ...sessionExpandState('default-allocation-code-types', false, '$'),
    header: [
        {
            view: 'block',
            className: 'expand-label',
            content: 'text:"Allocation code types"'
        },
        {
            view: 'switch',
            content: [
